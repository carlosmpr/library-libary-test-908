...
- It also imports icons (`DocumentTextIcon` and `ArrowUpTrayIcon`) from the `@heroicons/react` library for displaying icons in the component.
...
- If no files are selected, it shows a message to drag and drop files.
